    ...
    <AdminGuard>
      <div style={{ marginTop: "2rem" }}>
        ...
        >
          ...
          <button 
            onClick={() => router.push("/admin/lich-noi-bo")}
            style={{ flexShrink: 0, padding: "0.6rem 1.5rem", border: "none", background: "transparent", color: "var(--text-secondary)", borderRadius: "8px", fontWeight: "600", cursor: "pointer", transition: "all 0.2s" }}
          >
