  ...
  return (
    <footer style={{ 
      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "2rem" }}>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "800", background: "linear-gradient(135deg, #4f46e5, #9333ea)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Lịch Học Pro
            </span>
          </div>
          <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem", lineHeight: "1.6", marginBottom: "1.5rem" }}>
            Hệ thống quản lý lịch học chuyên nghiệp, giúp tối ưu hóa thời gian và nâng cao hiệu quả công việc cho sinh viên và ban quản lý.
          </p>
          
          <div style={{ display: "flex", gap: "1rem" }}>
            <a 
              href="tel:0852866856" 
              style={{ display: "flex", alignItems: "center", gap: "8px", background: "rgba(79, 70, 229, 0.1)", color: "var(--primary)", padding: "0.6rem 1rem", borderRadius: "8px", textDecoration: "none", fontWeight: "600", fontSize: "0.9rem", transition: "all 0.2s" }}
            >
      ...
      <div className="container" style={{ marginTop: "3rem", paddingTop: "1.5rem", borderTop: "1px solid rgba(226, 232, 240, 0.8)", textAlign: "center", color: "var(--text-secondary)", fontSize: "0.85rem" }}>
        &copy; {new Date().getFullYear()} Lịch Học Pro. Tất cả quyền được bảo lưu.
      </div>
    </footer>
  );
}
